...
# 4th Update
Finialized some code to add a temperature effect to the model. The coefficient used here is -0.4% per degree Celcius above STC Standard Testing Conditions. Generally, as solar panels get warmer under sunlight, the efficiency of the panel is reduced. More intense exposure to sunlight will also permanently reduce the panel's efficiency overtime which is why they have a life cycle. Another update to add to this project is the implementation of this model into a real-world system to test the efficacy. Currently, I am experimenting with various micro-controllers and sensors to develop a system to gather data, run the model, and train the model at the same time throughout a long duration. The current phase is still in development and I am almost finished with the basic implementation of the data gathering components. 